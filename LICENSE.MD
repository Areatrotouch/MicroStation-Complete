...
# MicroStation Complete

<p align="center">
  <img src="banner.png" alt="MicroStation Complete" width="100%">
</p>

MicroStation Complete — Windows 11 and 10 build | modeling | every module enabled | no edition limits.

## About this application

**MicroStation Complete** in this repo is a Windows desktop package for engineers, drafters, and design teams who want the full desktop experience without missing tools or locked panels. This is the complete professional build — every module that normally sits behind a paid tier is already active, so you can use modeling, drafting, and professional CAD workflows from the first launch. Expect a guided setup through PowerShell, a responsive workspace on a standard PC, and workflows that feel like the top-tier edition from day one.
...
MicroStation Complete suits engineers, drafters, and design teams who need a straightforward Windows install and a workflow that does not stop at basic features. If you rely on modeling, drafting, and professional CAD workflows daily, this package keeps the entire toolkit open — no trial countdown, no feature gates, and no need to upgrade inside the app.
